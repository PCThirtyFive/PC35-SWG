object_draft_schematic_clothing_clothing_armor_mando_chest = object_draft_schematic_clothing_shared_clothing_armor_mando_chest:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Mando Armor Chest Plate",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_mando_chest, "object/draft_schematic/clothing/clothing_armor_mando_chest.iff")
