object_draft_schematic_armor_armor_appearance_stormtrooper_chest = object_draft_schematic_armor_shared_armor_appearance_stormtrooper_chest:new {
   ...
   contribution = {100, 100, 100, 100, 100, 100, 100, 100, 100},
	...
	targetTemplate = "object/tangible/wearables/armor/marine/shared_armor_appearance_stormtrooper_chest.iff",

	additionalTemplates = {
	}
}

ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_appearance_stormtrooper_chest, "object/draft_schematic/armor/shared_armor_appearance_stormtrooper_chest.iff")
