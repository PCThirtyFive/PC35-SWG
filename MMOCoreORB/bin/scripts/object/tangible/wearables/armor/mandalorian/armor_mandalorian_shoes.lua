...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_mandalorian_armor_mandalorian_shoes, "object/tangible/wearables/armor/mandalorian/shared_armor_mandalorian_shoes.iff")
