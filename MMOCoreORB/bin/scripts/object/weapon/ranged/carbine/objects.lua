...
object_weapon_ranged_carbine_shared_carbine_sonicgeo = SharedWeaponObjectTemplate:new {
	clientTemplateFileName = "object/weapon/ranged/carbine/shared_carbine_sonicgeo.iff"
}

ObjectTemplates:addClientTemplate(object_weapon_ranged_carbine_shared_carbine_sonicgeo, "object/weapon/ranged/carbine/shared_carbine_sonicgeo.iff")
