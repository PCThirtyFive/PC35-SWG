...
object_weapon_melee_polearm_shared_lance_trando = SharedWeaponObjectTemplate:new {
	clientTemplateFileName = "object/weapon/melee/polearm/ep3/shared_lance_trando.iff"
}

ObjectTemplates:addClientTemplate(object_weapon_melee_polearm_shared_lance_trando, "object/weapon/melee/polearm/ep3/shared_lance_trando.iff")
