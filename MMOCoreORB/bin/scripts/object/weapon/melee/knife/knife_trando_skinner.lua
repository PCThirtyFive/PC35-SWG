...
object_weapon_melee_knife_knife_trando_skinner = object_weapon_melee_knife_shared_knife_trando_skinner:new {
	playerRaces = {
...
ObjectTemplates:addTemplate(object_weapon_melee_knife_knife_trando_skinner, "object/weapon/melee/knife/ep3/knife_trando_skinner.iff")
