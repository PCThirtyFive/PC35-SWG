...
object_weapon_melee_knife_knife_naktra_crystal = object_weapon_melee_knife_shared_knife_naktra_crystal:new {
	playerRaces = {
...
ObjectTemplates:addTemplate(object_weapon_melee_knife_knife_naktra_crystal, "object/weapon/melee/knife/ep3/knife_naktra_crystal.iff")
